...
# To keep track of how many solves in a session
num_solves = 0

# Average number of moves in a 4x4 scramble
num_moves = 44
...
def time_save(time):
    mins = time // 60    # Calculate mins
    sec = time % 60    # Calculate hours
    hours = mins // 60
    mins = mins % 60             # Add the extra minutes
